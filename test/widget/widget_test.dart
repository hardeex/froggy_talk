...
import 'package:froggytalk_assessment/core/constants/app_theme.dart';
...
import 'package:froggytalk_assessment/presentation/widgets/common/wallet_card.dart';
import 'package:froggytalk_assessment/presentation/widgets/common/activity_list_item.dart';
import 'package:froggytalk_assessment/presentation/widgets/common/app_button.dart';
import 'package:froggytalk_assessment/presentation/widgets/common/state_widgets.dart';
...
void main() {
  group('WalletCard', () {
    ...
    testWidgets('shows last top-up date when available', (tester) async {
      final wallet = makeWallet(lastTopUpDate: DateTime(2024, 6, 10));
  ...
  group('ActivityListItem', () {
    testWidgets('renders Top-Up label', (tester) async {
      ...
      await tester.pumpWidget(
        _wrapWidget(ActivityListItem(activity: activity)),
      );
  ...
  group('AppButton', () {
    testWidgets('renders label text', (tester) async {
      await tester.pumpWidget(
        _wrapWidget(AppButton(label: 'Top Up', onPressed: () {})),
      );
    ...
    testWidgets('fires onPressed callback when tapped', (tester) async {
      var tapped = false;
      await tester.pumpWidget(
        _wrapWidget(AppButton(label: 'Go', onPressed: () => tapped = true)),
      );
    ...
    testWidgets('does not fire callback when disabled (null onPressed)', (
      ...
      var tapped = false;
      await tester.pumpWidget(
        _wrapWidget(AppButton(label: 'Go', onPressed: null)),
      );
  ...
  group('ErrorStateWidget', () {
    ...
    testWidgets('shows retry button when onRetry is provided', (tester) async {
      ...
      await tester.pumpWidget(
        _wrapWidget(
          ErrorStateWidget(message: 'Failed', onRetry: () => retried = true),
        ),
      );
    ...
    testWidgets('hides retry button when onRetry is null', (tester) async {
      await tester.pumpWidget(
        _wrapWidget(const ErrorStateWidget(message: 'Failed')),
      );
